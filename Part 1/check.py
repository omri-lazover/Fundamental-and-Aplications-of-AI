...
import time
import ex1_318862323_206373367
...
def check_problem(p, search_method, timeout):
    ...
    if isinstance(s, search_318862323_206373367.Node):
        solve = s
...
def solve_problems(problems):
    ...
    for problem in problems:
        try:
            p = ex1_318862323_206373367.create_onepiece_problem(problem)
        except Exception as e:
            print("Error creating problem: ", e)
            return None
        timeout = 60
        result = check_problem(
            p, (lambda p: search_318862323_206373367.astar_search(p, p.h)), timeout)
        print("A* ", result)
        if result[2] != None:
            if result[0] != -3:
                solved = solved + 1
...
def main():
    print(ex1_318862323_206373367.ids)
    ...
    problems = [
        ...
        },
        {
            ...
            "treasures": {'treasure_1': (4, 5), 'treasure_2': (1, 1), 'treasure_3': (1, 6), 'treasure_4': (5, 6)},
            "marine_ships": {'marine_1': [(4, 1), (4, 2)], 'marine_2': [(3, 5), (3, 4), (4, 4)],
                             'marine_3': [(1, 2), (1, 3), (1, 4)]},
        },
    ...
    problems3 = [
        ...
        },
        {
            'map': [['S', 'S', 'S', 'I', 'S', 'S', 'S'],
                    ...
                    ['S', 'S', 'S', 'S', 'S', 'I', 'S'],
                    ['S', 'S', 'S', 'I', 'S', 'S', 'S']],
            'pirate_ships': {'pirate_ship_1': (3, 1), "pirate_ship_2": (3, 1)},
            'treasures': {'treasure_1': (4, 5), 'treasure_2': (1, 1), 'treasure_3': (1, 6)},
            'marine_ships': {'marine_1': [(4, 1), (4, 2)], 'marine_2': [(3, 5), (3, 4), (4, 4)],
                             'marine_3': [(1, 2), (1, 3), (1, 4)], 'marine_4': [(5, 6)]},
        },
    ...
    problems4 = [
        ...
        },
        {
            'map': [['S', 'S', 'S', 'S', 'I'],
                    ...
                    ['S', 'S', 'S', 'S', 'S'],
                    ['B', 'S', 'S', 'I', 'S']],
            'pirate_ships': {'pirate_ship_1': (3, 0), "pirate_ship_2": (3, 0), 'pirate_ship_3': (3, 0)},
            'treasures': {'treasure_1': (3, 3), 'treasure_2': (1, 1), 'treasure_3': (0, 4)},
            'marine_ships': {'marine_1': [(3, 2)], 'marine_2': [(0, 2), (0, 3)], 'marine_3': [(3, 4), (2, 4)]},
        },
        {
    ...
    problems5 = [
        ...
        },
        {
            'map': [['S', 'S', 'I', 'S'],
                    ...
                    ['S', 'S', 'I', 'I'],
                    ['S', 'S', 'I', 'I']],
            'pirate_ships': {'pirate_ship_1': (1, 1), 'pirate_ship_2': (1, 1), 'pirate_ship_3': (1, 1)},
            'treasures': {'treasure_1': (2, 2), 'treasure_2': (2, 2), 'treasure_3': (3, 3)},
            'marine_ships': {'marine_1': [(0, 0), (0, 1), (0, 0), (1, 0), (2, 0)]}
        }
    ]
    ...
    solve_problems(problems3)
    solve_problems(problems5)
